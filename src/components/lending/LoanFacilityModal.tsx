  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>{isEditing ? 'Edit' : 'Add'} Loan Facility</DialogTitle>
          <DialogDescription>
            {isEditing ? 'Update this loan facility\'s terms and covenants.' : 'Register a new loan facility against this property.'}
          </DialogDescription>
        </DialogHeader>
