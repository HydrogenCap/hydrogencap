...
import {
  Mail, Phone, MessageSquare, FileText, Users, Globe,
  ArrowUpRight, ArrowDownLeft, Plus, Send, Smartphone, TrendingUp,
} from 'lucide-react';
...
import type { CommunicationChannel, CommunicationDirection } from '@/hooks/useCommunicationLog';
...
export function CommunicationsPanel() {
  ...
  const stats = useMemo(() => {
    ...
    return { total: thisMonth.length, outbound, inbound, channelBreakdown };
  }, [allComms, monthStart]);
