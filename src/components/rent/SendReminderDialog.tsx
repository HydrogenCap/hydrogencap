...
import { RentScheduleWithDetails, useSendReminder, normalizeRentItem } from '@/hooks/useRentCollection';
...
export default function SendReminderDialog({ item, open, onOpenChange }: SendReminderDialogProps) {
  ...
  const tenantEmail = display.tenantEmail || '';
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Send a reminder to {display.tenantName} about their rent payment for {propertyAddress}
          </DialogDescription>
        </DialogHeader>
