...
const schema = z.object({
  ...
  equity_percentage: z.coerce.number().min(0).max(100).optional().or(z.literal('')).transform(v => v === '' ? null : v),
  commitment_date: z.string().min(1, 'Date is required'),
  maturity_date: z.string().optional().transform(v => v || null),
  coupon_rate: z.coerce.number().min(0).optional().or(z.literal('')).transform(v => v === '' ? null : v),
