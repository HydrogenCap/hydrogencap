...
export const FACILITY_TYPES = [
  ...
  { value: 'development_finance', label: 'Development', color: 'bg-purple-100 text-purple-700 border-purple-300' },
  { value: 'mezzanine', label: 'Mezzanine', color: 'bg-red-100 text-red-700 border-red-300' },
  { value: 'overdraft', label: 'Overdraft', color: 'bg-slate-100 text-slate-700 border-slate-300' },
  { value: 'directors_loan', label: 'Directors Loan', color: 'bg-teal-100 text-teal-700 border-teal-300' },
  { value: 'second_charge', label: '2nd Charge', color: 'bg-indigo-100 text-indigo-700 border-indigo-300' },
] as const;
...
export const STATUS_COLORS: Record<string, string> = {
  ...
  pending_drawdown: 'bg-blue-100 text-blue-700',
  expired_product: 'bg-amber-100 text-amber-700',
};
